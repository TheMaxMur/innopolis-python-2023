...
async def main() -> None:
    pages = []
    products = [
        "https://chudopitomets.ru/product/royal-canin-dlya-shchenkov-gigantskikh-porod-2-8-mes-giant-puppy-34/",
        "https://chudopitomets.ru/product/fiory-korm-dlya-krolchat-puppypellet-granulirovannyy/",
        "https://chudopitomets.ru/product/fiory-biskvity-dlya-ptits-biscottelli-s-yablokom-35-g/"
    ]
    dump = []
    ...
    try:
        ...
        # for page in pages:
        try:
            [products.append(link) for link in await GetProducts(pages[0])]
        except ParseException as e:
            print(f"Ошибка: {e}")
